...
const Rideridverification2 = (props) => {
  ...
  return (
    <View style={styles.container}>
      <Commonheader
        title={`${
          type === "id" ? "ID" : type === "license" ? "License" : "Passport"
        } Verification`}
      ...
      <View style={styles.textwrapper}>
        ...
        <Text style={styles.contenttext}>
          ...
          {type === "id"
            ...
            ? "License"
            : "Passport"}
          . Make sure to capture both sides and photograph the ENTIRE ID in your{" "}
          {type === "id"
            ? "ID card"
            : type === "license"
            ? "License"
      ...
      <View style={styles.btnwrapper}>
        <StandardButton
          ...
          onPress={() =>
            props?.navigation?.navigate("Documentbackphoto", {
              type,
            })
          }
