  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.enterphonenumberwrapper}>
        <Text style={styles.enterphonenumbertext}>Enter your phone number</Text>
      </View>
      ...
      <View style={styles.btnwrapper}>
        <StandardButton
          ...
          onPress={() => props?.navigation?.navigate("Riderphoneverification")}
        />
      </View>
    </View>
  );
...
export default connect(mapStateToProps, {})(Riderenterphone);
